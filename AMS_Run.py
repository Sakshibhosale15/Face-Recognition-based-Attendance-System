...
window = tk.Tk()
window.title("#123456-Face Recognition Based Attendance Management System")
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/Sakshi Pc/Downloads/Attendace_management_system-master/Attendace_management_system-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\Sakshi Pc\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/Sakshi Pc/Downloads/Attendace_management_system-master/Attendace_management_system-master/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\Sakshi Pc\Downloads\Attendace_management_system-master\Attendace_management_system-master\Attendance\-------Check atttendance-------"')

    attf = tk.Button(windo,  text="Check Sheets",command=Attf,fg="white"  ,bg="#212122"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
    attf.place(x=430, y=255)

    sub = tk.Label(windo, text="Enter Subject", width=15, height=2, fg="white", bg="#212122", font=('times', 15, ' bold '))
    sub.place(x=30, y=100)

    tx = tk.Entry(windo, width=20, bg="grey", fg="blue", font=('times', 23, ' bold '))
    tx.place(x=250, y=105)

    fill_a = tk.Button(windo, text="Fill Attendance", fg="white",command=Fillattendances, bg="#123456", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
    ...
    def log_in():
        ...
        if username == 'kushal' :
            if password == 'kushal14320':
                ...
                cs = 'C:/Users/Sakshi Pc/Downloads/Attendace_management_system-master/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System", bg="#123456", fg="white", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=2, fg="white", bg="#212122", font=('times', 15, ' bold '))
...
lbl2 = tk.Label(window, text="Enter Name", width=20, fg="white", bg="#212122", height=2, font=('times', 15, ' bold '))
lbl2.place(x=200, y=300)

txt2 = tk.Entry(window, width=20, bg="white", fg="red", font=('times', 25, ' bold '))
txt2.place(x=550, y=310)

clearButton = tk.Button(window, text="Clear",command=clear,fg="white"  ,bg="#2B1B17"  ,width=10  ,height=1 ,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="white"  ,bg="#2B1B17"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
...
takeImg = tk.Button(window, text="Take Images",command=take_img,fg="white"  ,bg="#123456"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=220, y=500)

trainImg = tk.Button(window, text="Train Images",fg="white",command=trainimg ,bg="#123456"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
trainImg.place(x=520, y=500)

FA = tk.Button(window, text="Take Attendace",fg="white",command=subjectchoose  ,bg="#123456"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
FA.place(x=820, y=500)
